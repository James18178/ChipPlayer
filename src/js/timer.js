    ...
    initloadingChecker() {
        ...
        this.loadingChecker = setInterval(() => {
            if (this.enableloadingChecker) {
                ...
                if (!bufferingDetected && currentPlayPos === lastPlayPos && !this.player.audio.player_state_playing) {
                    this.player.container.classList.add('chipplayer-loading');
                    bufferingDetected = true;
                }
                if (bufferingDetected && currentPlayPos > lastPlayPos && !this.player.audio.player_state_playing) {
                    this.player.container.classList.remove('chipplayer-loading');
